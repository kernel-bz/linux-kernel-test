 ...
 * Update for user test by Jung-JaeJoon <rgbi3307@gmail.com> on www.kernel.bz
 */
...
//1250
#ifdef CONFIG_UNITTEST_OF_OVERLAY
...
#if IS_BUILTIN(CONFIG_I2C) && IS_ENABLED(CONFIG_UNITTEST_OF_OVERLAY)
