...
static void calc_runnable_avg_yN_inv(void)
{
	int i;
	unsigned int x;
...
static void calc_runnable_avg_yN_sum(void)
{
	int i;
...
static void calc_converged_max(void)
{
...
static void calc_accumulated_sum_32(void)
{
	int i, x = sum;
